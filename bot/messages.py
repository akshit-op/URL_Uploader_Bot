...
common_text = "\n\n<u>If you are facing any problem, so report at @Family_bites.</u>"
...
start_msg = f"<b>Hi, I am URL_UploaderBot Created by @Akshit_Sinha and My Developer is @Akshit_sinha.</b>\n{help_msg}"
